...
def create_app():
    ...
    CORS(app, origins=["http://localhost:5173", "https://ingridalfred-designlinear-4000.codio.io", "https://ingridalfred-designlinear-5173.codio.io"], supports_credentials=True)
